...
public class Footprint {
    ...
    @Ignore
    public Footprint(Integer id, Integer serverId, String title, String description, String nodeList, String createTime, String creator, String length, Long totalTime, Integer privacy) {
        this.id = id;
